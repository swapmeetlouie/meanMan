...
// ]},{ 'name': 'FY19', 'series': [ {'name': 'OTSB Products', 'desc': 'FY19 YTD', 'value': 1951.254336},{'name': 'OTSB Services', 'desc': 'FY19 YTD', 'value': 878.560032},{'name': 'SB Products', 'desc': 'FY19 YTD', 'value': 183.090613},{'name': 'SB Services', 'desc': 'FY19 YTD', 'value': 423.756270}]}]
  ...
  percFormat(value): string {
    return '';
   
    // return (value*10).toFixed(1); 
      // return sbPerc.toFixed(2);
      // return (post.percSb).toFixed(2);sb
      // value.toFixed(2); 

      // return (this.post.percSb).toFixed(2);
      //  post.sbSpend/post.totalSpend }
    // }
        ...
        this.postsService.getPost(this.majCom).subscribe(postData => {
          ...
          this.post = {
            ...
            majCom: postData.majCom, 
                      ...
                      sbSpend: postData.sbSpend, 
                      newSbSpend: postData.newSbSpend,
                      otsbSpend: postData.otsbSpend, percSb: postData.percSb,
                      spendBreak: [{'name': 'Other Than SB', 'value':postData.otsbSpend, 'extra':'ff'},{'name': 'Small Business', 'value':postData.sbSpend}],
                      ...
                      cardSpend: [{'name': 'Small Business', 'value': postData.newSbSpend},
